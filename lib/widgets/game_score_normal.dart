...
class GameScoreNormal extends StatefulWidget {
  
  const GameScoreNormal({Key? key,}) : super(key: key);

  @override
  State<GameScoreNormal> createState() => _GameScoreNormalState();
}

class _GameScoreNormalState extends State<GameScoreNormal> {
 AdRequest? adRequest;
  BannerAd? bannerAd;
